...
export class Backend implements backendInterface {
    ...
    async getAllResults(): Promise<Array<GameResult>> {
    ...
    async getPlayerResults(arg0: Principal): Promise<Array<GameResult>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPlayerResults(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
